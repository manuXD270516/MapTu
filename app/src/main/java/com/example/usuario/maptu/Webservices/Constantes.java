...
public class Constantes {
    ...
    String s="192.168.0.28";


    private static final String IP ="192.168.0.28";//"192.168.43.168";/*"www.pruebaws.hol.es";*///"192.168.0.29" ;//"192.168.0.166";//"10.0.3.2";
    /**
    ...
    public static final String GET_CATEGORIAS = "http://" + IP + PUERTO_HOST + "/WebServices_Maptu/Controller_ObtenerCategoria.php";
    public static final String HTTP_USER="http://" + IP + PUERTO_HOST + "/WebServices_Maptu/Controller_User.php";
